...
$dev_codepath = '*';
$dev_baseurl = 'https://oc3.baiti.net/';
...
// Docker: standalone, no external include

// database access
$opt['db']['servername'] = 'db';
$opt['db']['username'] = 'oc';
$opt['db']['password'] = '65dd4741d3ed9ed2460041fb81caa992';
$opt['db']['pconnect'] = false;

$opt['db']['maintenance_user'] = 'oc';
$opt['db']['maintenance_password'] = '65dd4741d3ed9ed2460041fb81caa992';
...
$opt['session']['path'] = '/';
$opt['session']['domain'] = '.oc3.baiti.net';    // may be overwritten by $opt['domain'][...]['cookiedomain']
$opt['debug'] = true;
 ...
 */
$opt['forum']['url'] = 'https://oc3.baiti.net/rss_forum.php';
...
function post_config(): void
{
    ...
    $menuitem[MNU_API] = [
        ...
        'menustring' => 'API',
        'authlevel' => 0,
        'href' => 'https://oc3.baiti.net/okapi',
